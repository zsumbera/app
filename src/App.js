...
const images = {
  product2: require('./6I8B0457-500x692.jpg'),
  product1: require('./miele-cm-6160-2.webp'),
};


const products = [
  { id: 1, name: "Miele Mosógép", price: 120000, img: images.product2, description: "Miele mosógép W Meteor3000, használt, szervizünk által felújított , ezért garanciával adunk rá." },
  { id: 2, name: "Miele Kávéfőző", price: 250000, img: images.product1, description: "Ez egy Miele Kávéfőző" },
  { id: 3, name: "Miele Kávéfőző", price: 350000, img: images.product2, description: "Ez egy Miele Kávéfőző" },
  { id: 4, name: "Miele Mosógép", price: 120000, img: images.product1, description: "Miele mosógép W Meteor3000, használt, szervizünk által felújított , ezért garanciával adunk rá." },
  { id: 5, name: "Miele Kávéfőző", price: 250000, img: images.product2, description: "Ez egy Miele Kávéfőző" },
  // További termékek...
];
        ...
        <Navbar.Collapse id="basic-navbar-nav" in={isNavOpen}>
          <div className="d-flex flex-lg-row flex-column align-items-center w-100">
            ...
            <Link to="/cart" className="btn btn-light" onClick={closeNavbar}>
              <img className="sml_logo" src={require("./shopping-cart.png")} alt="kep" />
              Kosár ({cart.length})
            </Link>
          </div>
        </Navbar.Collapse>
...
function ProductCarousel() {
  return (
    <div className="carousel-container mt-4">
      <Carousel>
        <Carousel.Item>
          <img className="d-block mx-auto img-fluid" src={require('./slide_show_miert_miele.jpg')} alt="Hirdetés 1" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block mx-auto img-fluid" src={require('./slide_show_gepek.jpg')} alt="Hirdetés 2" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block mx-auto img-fluid" src={require('./slide_show_szerviz.jpg')} alt="Hirdetés 3" />
        </Carousel.Item>
      </Carousel>
    </div>
  );
  ...
  return (
    <footer className="custom-footer">
      <div className="footer-content">
        <img src={require("./infoblokk_kedv_final_CMYK_ERFA.jpg")} alt="Logo" className="footer-image" />
